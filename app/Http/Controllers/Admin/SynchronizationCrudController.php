 ...
 */
class SynchronizationCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Synchronization::class);
    ...
    {
        CRUD::setValidation(SynchronizationRequest::class);
