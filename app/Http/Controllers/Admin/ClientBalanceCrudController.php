...
use App\Http\Requests\ClientBalanceRequest;
...
class ClientBalanceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\ClientBalance::class);
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('total_supply');
        CRUD::column('last_supply');
    ...
    {
        CRUD::setValidation(ClientBalanceRequest::class);
