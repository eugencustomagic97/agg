...
/**
 * Class ReturnsCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ReturnsCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Returns::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/returns');
        CRUD::setEntityNameStrings('returns', 'returns');
    }
    ...
    {
        CRUD::setValidation(ReturnsRequest::class);
